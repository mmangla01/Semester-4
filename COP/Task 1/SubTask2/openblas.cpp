// matrix multiplication implemenation using the openblas library
#include <iostream>
#include "Matrix.h"					// Matrix class
#include "/usr/include/x86_64-linux-gnu/openblas-pthread/cblas.h"// address to the openblas.h header in the machine
