signature  FILEIO =
sig
    val getclist : string -> TextIO.StreamIO.elem list (* get a list of characters from a file *)
    val getclistNN : string -> char list (* get list of chars except newline characters *)
    val slurp : string -> TextIO.StreamIO.vector (* Get the contents of an entire text file as a string *)
    val readAll : string -> TextIO.StreamIO.vector (* Reading a chunk of characters at a time and outputting a list of strings *)
    val bite : string -> string list (* Reading by lines list of strings *)
